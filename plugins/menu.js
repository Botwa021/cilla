...
const defaultMenu = {
  before: `
Hi %name
ℓααcηxz · вσт adalah bot whatsapp yang di bangun dengan menggunakan node-js dengan menggunakan server yang sangat kencang tapi tidak terlalu kencang banget.

 ◦ Library : Baileys
 ◦ Function : Role
 ◦ Instagram : https://instagram.com/cilaaacnxz
 ◦ Bot Name : ℓααcηxz · вσт
...
handler.help = ['menu']
handler.tags = ['main']
handler.command = /^(allmenu|menu|help|cilabocil|cil|cila|menunya)$/i
